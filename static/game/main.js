...
const rollButtonContainer = await getButtonContainerByName('largeGreen', {text: "Roll!", color: 0x787676}, app.screen.width / 2, app.screen.height - (app.screen.height / 7.20), 1.3, 64, 32, onRollClick)

const minusButtonContainer = await getButtonContainerByName('bluePent', {text:"-", color: 0x787676}, app.screen.width / minusButtonXFactor, app.screen.height - (app.screen.height / 7.20), 1.3, 32, null, onMinusClick)

const plusButtonContainer = await getButtonContainerByName('bluePent', {text:"+", color: 0xffffff}, app.screen.width / plusButtonXFactor, app.screen.height - (app.screen.height / 7.20), 1.3, 32, null, onPlusClick)
